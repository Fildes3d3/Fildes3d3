...
**Craft CMS & Nuxt contractor. PHP/Symfony + Vue since the early days, decoupled by conviction.**
 
I build headless CMS architectures — a structured content backend, an API boundary, and a server-rendered frontend that stays fast and debuggable in production. I've been building this same architecture for nine years, across three generations of tooling:
...
- **Web:** [popadrianbogdan.com](https://www.popadrianbogdan.com)
- **Email:** popadrianbogdan@icloud.com
- **Base:** Cluj-Napoca, Romania — working remotely with EU clients
